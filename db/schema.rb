...
ActiveRecord::Schema.define(version: 20_150_816_124_941) do
  ...
  create_table 'subscriptions', force: :cascade do |t|
    ...
    t.datetime 'created_at',        null: false
    t.datetime 'updated_at',        null: false
    t.string 'subscrivable_type'
    t.integer 'subscrivable_id'
  end

  add_index 'subscriptions', %w(subscrivable_id subscrivable_type), name: 'index_subscriptions_on_subscrivable_id_and_subscrivable_type', using: :btree
